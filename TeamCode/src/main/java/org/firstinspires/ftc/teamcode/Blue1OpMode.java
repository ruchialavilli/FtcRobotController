...
@Autonomous(name = "Blue1OpMode", group = "AutoOpModes")
public class Blue1OpMode extends BaseAutoVisionOpMode {
    private String TAG = "Blue1OpMode";
...
//TODO: Add cone guards and change as needed
    // parking locations
    // stop sign
    protected static Vector2d location1 = new Vector2d(-11.5, 58);
    // traffic lights
    protected static Vector2d location2 = new Vector2d(-11.5, 32.25);
    // teddy bear
    protected static Vector2d location3 = new Vector2d(-11.5, 8);
...
//                        Log.d(TAG, "executing arm action: going to level Done");
        ...
        Trajectory traj0 = drive.trajectoryBuilder(startPose)
                .lineTo(new Vector2d(-7.5, 32))
                .build();

        Trajectory traj1 = drive.trajectoryBuilder(traj0.end())
                .lineTo(new Vector2d(-11.5, 32))
                .build();//9.25
        ...
        Trajectory traj6 = drive.trajectoryBuilder(traj5.end().plus(new Pose2d(0, 0, Math.toRadians(-139))))
                .forward(11.5)
                .build();
...
//        drive.followTrajectory(traj7);
        ...
        drive.followTrajectory(
                drive.trajectoryBuilder(traj7.end().plus(new Pose2d(0, 0, Math.toRadians(-45))))
